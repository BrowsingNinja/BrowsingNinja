...
contract BrowsingNinja is PausableToken {
    string public constant name = "BrowsingNinja";
    string public constant symbol = "BRNI";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_UNIT = 10 ** uint256(decimals);

    uint256 public constant totalSupply = 250000000 * TOKEN_UNIT;
    uint256 public constant publicAmount = 200000000 * TOKEN_UNIT; // Tokens for public

    uint public startTime;
    address public crowdsaleAddress;

    function BrowsingNinja() public {
