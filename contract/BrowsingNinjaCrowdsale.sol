...
/**
 * @title BrowsingNinja Crowdsale
 */
contract BrowsingNinjaCrowdsale {
    ...
    // Soft cap in tokens. 1% of public tokens.
    uint256 constant public softCap = 2000000 * (10**18);

    // Hard cap in tokens. 100% of public tokens.
    uint256 constant public hardCap = 200000000 * (10**18);
     ...
     */
    function BrowsingNinjaCrowdsale(uint256 _startTime, uint256 _endTime, address _wallet, address _token, address _owner)  public {
